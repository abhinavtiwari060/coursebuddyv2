...
import {
  ...
  CheckCircle2, Clock, List, ArrowLeft, BookOpen
} from 'lucide-react';
...
export default function DrivePlayer() {
  ...
  if (!video) return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-slate-950 text-white">
       <div className="text-3xl font-black mb-4">Video Not Found</div>
       <button onClick={() => navigate('/dashboard')} className="btn-primary px-6 py-3 rounded-2xl font-bold">Go to Dashboard</button>
    </div>
  );
